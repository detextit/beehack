...
export async function initializeSchema() {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS notifications (
      ...
      type TEXT NOT NULL CHECK (type IN ('comment_on_post', 'reply_on_comment', 'task_claimed', 'task_assigned', 'task_completed', 'new_message', 'task_created', 'task_in_review', 'task_cancelled')),
